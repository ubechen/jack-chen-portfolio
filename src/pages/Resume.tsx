          ...
          <ScrollReveal>
            <section className="py-8 border-t border-border">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                我是 Jack，擅長將複雜需求與新技術轉化為可落地體驗的 Product / UX 設計師。累積 10+ 年設計實務經驗，其中 8 年在緯創參與多端與系統型產品，橫跨 AI 筆電、服務型機器人、無人機、醫療復健與 ESG 專案。我習慣先把題目問清楚、對齊目標與成功指標，再用研究、流程設計與驗證降低不確定性，推進跨部門共識，將方向落實為可上線、可驗證、能帶來成效的產品體驗。下一步希望在不設限產業的前提下<span className="whitespace-nowrap">(B2B/B2C 皆可)</span>，加入重視協作與落地的團隊，做出同時改善使用者體驗、帶動產品目標與成效的設計
              </p>
            </section>
          </ScrollReveal>
